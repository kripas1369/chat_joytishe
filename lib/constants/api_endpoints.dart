class ApiEndpoints {
  ...
  //   static const String baseUrl = 'http://192.168.1.73:4000/api/v1';
    static const String baseUrl = 'https://jotishapi.autonomoustechnology.net/api/v1';
  ...
  static const String astrologerLoginWithPassword = '$baseUrl/astrologer/auth/login';
  ...
  static const String updateUserBirthDetails = '$baseUrl/users/me/birth-details';
