...
class BookPanditScreen extends StatefulWidget {
  const BookPanditScreen({super.key});

  @override
  State<BookPanditScreen> createState() => _BookPanditScreenState();
}

class _BookPanditScreenState extends State<BookPanditScreen>
  ...
  final List<CategoryItem> categories = [
    CategoryItem(
      name: 'Religious Pujas',
      icon: Icons.temple_hindu,
      description: 'Traditional worship ceremonies',
      colors: [Color(0xFF9333EA), Color(0xFFDB2777)],
    ),
    CategoryItem(
      name: 'Marriage & Family Rituals',
      icon: Icons.family_restroom,
      description: 'Wedding and family events',
      colors: [Color(0xFFDB2777), Color(0xFFE44949)],
    ),
    CategoryItem(
      name: 'Life Event Ceremonies',
      icon: Icons.celebration,
      description: 'Birth, naming, thread ceremony',
      colors: [Color(0xFFE44949), Color(0xFFF97316)],
    ),
    CategoryItem(
      name: 'Astrology & Graha Remedies',
      icon: Icons.auto_awesome,
      description: 'Planetary remedies and solutions',
      colors: [Color(0xFFF97316), Color(0xFFFB923C)],
    ),
    CategoryItem(
      name: 'Festival and Special Pujas',
      icon: Icons.diamond,
    ...
    CategoryItem(
      ...
      description: 'Other religious services',
      colors: [Color(0xFFDB2777), Color(0xFFE44949)],
    ),
  ];
